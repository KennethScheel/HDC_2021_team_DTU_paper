...
for h = 1:length(RADII)
    for j = 1:length(ETA)
        for i = 1:length(LAMBDA)
            ...
            eta = ETA(j);                            % noise level in percentage
            ...
            % Other Parameters
            lambda_TV = LAMBDA(i);            % Regularization parameter for TV
            ...
            if save_x_test == 1
                ...
                output_file = fullfile(test_folder,[images{im}(1:end-4) '_r_' num2str(r_true)...
